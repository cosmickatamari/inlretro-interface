...
function Select-Mapper {
    ...
    Show-Header
    Write-Host "`nFor quicker access to important information, the NES database has opened to the search results from the game title." -ForegroundColor Blue
